/*
Реализовать утилиту WordCount подсчитывающую количествострок, слов и байт для указанного файла и выводить эту информацию в поток вывода.

Программа должна поддерживать следующие опции:
-l, --lines -c, --bytes -w, --words вывод только количества строк, вывод размера файла в байтах, вывод количества слов.
